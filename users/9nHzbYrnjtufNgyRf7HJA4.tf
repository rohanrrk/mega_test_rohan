import {
  to = segment_user.id-9nHzbYrnjtufNgyRf7HJA4
  id = "9nHzbYrnjtufNgyRf7HJA4"
}

resource "segment_user" "id-9nHzbYrnjtufNgyRf7HJA4" {
  email = "inviteduser01@bugcrowdninja.com"
  permissions = [
    {
      resources = [
        {
    ...
    },
    {
      ...
      role_id = "1Mc8DJJa7MQ9L8HiZz5NL4QMgdj"
    },
    {
      resources = [
        {
